...
function mulit($count, $page, $perpage) {
	...
	$i = 1;
	$pager = "<nav id='mulit'><a class='bulberight' href='?dir=$dir&page=1' data-infos='First page'><em>First</em></a>";
	while($allpage) {
		$class = '';
		if ($i == $page) {
			$class = 'class = "current"'; 
		...
		if ($dir) {
			...
			$pager .= "<a class='bulbeleft'  href='?page=$i' data-infos='Go to page $i'><em $class>";    
		}
		$pager .= "$i";
		$pager .= "</em></a>";
		$i ++;
	...
	$next = $page + 1;
	$pager .= "<a class='bulberight' href='?dir=$dir&page=$last' data-infos='Last page'><em>Last</em></a>";
	$pager .= "<a class='bulbeleft' href='?dir=$dir&page=$next' data-infos='Next page'><em>NEXT</em></a></nav>";
	return $pager;
}
// DATA CHECK
// PHP
